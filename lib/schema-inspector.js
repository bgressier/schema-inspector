...
// Validation ------------------------------------------------------------------
	...
	Validation.custom = {};
	Validation.extend = function (custom) {
		return _extend(Validation.custom, custom);
	};
	Validation.reset = function () {
		Validation.custom = {};
	};
	Validation.remove = function (fields) {
		if (!Array.isArray(fields)) {
			fields = [fields];
		}
		fields.forEach(function (field) {
			delete Validation.custom[field];
		});
	};
...
// Sanitization ----------------------------------------------------------------
	...
	Sanitization.custom = {};
	Sanitization.extend = function (custom) {
		return _extend(Sanitization.custom, custom);
	};
	Sanitization.reset = function () {
		Sanitization.custom = {};
	};
	Sanitization.remove = function (fields) {
		if (!Array.isArray(fields)) {
			fields = [fields];
		}
		fields.forEach(function (field) {
			delete Sanitization.custom[field];
		});
	};
