...
// Validation ------------------------------------------------------------------
	...
	Validation.prototype.validate = function (candidate) {
		return this._validate(this._schema, candidate);
	};
...
// Sanitization ----------------------------------------------------------------
	...
	Sanitization.prototype.sanitize = function (post) {
...
// Exports ---------------------------------------------------------------------
	...
	SchemaInspector.sanitize = function (schema, post, custom) {
		return new Sanitization(schema, custom).sanitize(post).result();
	};

	SchemaInspector.validate = function (schema, candidate, custom) {
		return new Validation(schema, custom).validate(candidate).result();
	};
